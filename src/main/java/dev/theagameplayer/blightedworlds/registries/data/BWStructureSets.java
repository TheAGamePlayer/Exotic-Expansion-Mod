...
public final class BWStructureSets {
	public static final ResourceKey<StructureSet> INFERNAL_FORTRESS = ResourceKey.create(Registries.STRUCTURE_SET, BlightedWorldsMod.namespace("infernal_fortress"));
